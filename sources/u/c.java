...
public final class c {
    ...
    class a extends InputConnectionWrapper {
        ...
        final /* synthetic */ C0212c f12457a;

        /* JADX INFO: super call moved to the top of the method (can break code semantics) */
        a(InputConnection inputConnection, boolean z9, C0212c cVar) {
            super(inputConnection, z9);
            this.f12457a = cVar;
        }

        public boolean commitContent(InputContentInfo inputContentInfo, int i10, Bundle bundle) {
            if (this.f12457a.a(d.f(inputContentInfo), i10, bundle)) {
                return true;
            }
    ...
    class b extends InputConnectionWrapper {
        ...
        /* renamed from: a  reason: collision with root package name */
        final /* synthetic */ C0212c f12458a;

        /* JADX INFO: super call moved to the top of the method (can break code semantics) */
        b(InputConnection inputConnection, boolean z9, C0212c cVar) {
            super(inputConnection, z9);
            this.f12458a = cVar;
        }

        public boolean performPrivateCommand(String str, Bundle bundle) {
            if (c.e(str, bundle, this.f12458a)) {
                return true;
            }
    ...
    private static C0212c b(View view) {
        h.j(view);
        return new b(view);
    }
    ...
    @Deprecated
    public static InputConnection d(InputConnection inputConnection, EditorInfo editorInfo, C0212c cVar) {
        ...
        return Build.VERSION.SDK_INT >= 25 ? new a(inputConnection, false, cVar) : a.a(editorInfo).length == 0 ? inputConnection : new b(inputConnection, false, cVar);
    }

    /* JADX WARNING: Removed duplicated region for block: B:46:0x007d  */
    /* Code decompiled incorrectly, please refer to instructions dump. */
    static boolean e(java.lang.String r7, android.os.Bundle r8, u.c.C0212c r9) {
        /*
            r0 = 0
        ...
        L_0x005e:
            ...
            u.d r8 = new u.d     // Catch:{ all -> 0x0077 }
        ...
        L_0x0081:
            return r0
        */
        throw new UnsupportedOperationException("Method not decompiled: u.c.e(java.lang.String, android.os.Bundle, u.c$c):boolean");
    }
    ...
    public static /* synthetic */ boolean f(View view, d dVar, int i10, Bundle bundle) {
        ...
        return x.Z(view, new c.a(new ClipData(dVar.b(), new ClipData.Item(dVar.a())), 2).d(dVar.c()).b(bundle).a()) == null;
    }
}
