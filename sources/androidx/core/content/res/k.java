...
public class k {
    public static boolean a(TypedArray typedArray, XmlPullParser xmlPullParser, String str, int i10, boolean z9) {
        return !j(xmlPullParser, str) ? z9 : typedArray.getBoolean(i10, z9);
    }
