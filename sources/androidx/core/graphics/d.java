...
public class d {
    ...
    public static class b {
        ...
        b(b bVar) {
            ...
            float[] fArr = bVar.f1460b;
            this.f1460b = d.c(fArr, 0, fArr.length);
        }
        ...
        private static void c(Path path, float f10, float f11, float f12, float f13, float f14, float f15, float f16, boolean z9, boolean z10) {
            double d10;
            double d11;
            float f17 = f10;
            float f18 = f12;
            ...
            if (d32 < 0.0d) {
                ...
                c(path, f10, f11, f12, f13, f19 * sqrt, f15 * sqrt, f16, z9, z10);
                return;
            }
        ...
        public static void e(b[] bVarArr, Path path) {
            ...
            for (int i10 = 0; i10 < bVarArr.length; i10++) {
                a(path, fArr, c10, bVarArr[i10].f1459a, bVarArr[i10].f1460b);
                c10 = bVarArr[i10].f1459a;
            }
        }
        ...
        public void d(b bVar, b bVar2, float f10) {
            ...
            while (true) {
                float[] fArr = bVar.f1460b;
                if (i10 < fArr.length) {
                    this.f1460b[i10] = (fArr[i10] * (1.0f - f10)) + (bVar2.f1460b[i10] * f10);
                    i10++;
                } else {
                    return;
                }
    ...
    public static boolean b(b[] bVarArr, b[] bVarArr2) {
        ...
        for (int i10 = 0; i10 < bVarArr.length; i10++) {
            if (bVarArr[i10].f1459a != bVarArr2[i10].f1459a || bVarArr[i10].f1460b.length != bVarArr2[i10].f1460b.length) {
                return false;
            }
        }
        return true;
    ...
    public static void j(b[] bVarArr, b[] bVarArr2) {
        for (int i10 = 0; i10 < bVarArr2.length; i10++) {
            bVarArr[i10].f1459a = bVarArr2[i10].f1459a;
            for (int i11 = 0; i11 < bVarArr2[i10].f1460b.length; i11++) {
                bVarArr[i10].f1460b[i11] = bVarArr2[i10].f1460b[i11];
            }
        }
    }
}
