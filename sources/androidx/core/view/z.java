...
public final class z {
    ...
    static {
        if (Build.VERSION.SDK_INT == 25) {
            try {
                f1829a = ViewConfiguration.class.getDeclaredMethod("getScaledScrollFactor", new Class[0]);
    ...
    private static float a(ViewConfiguration viewConfiguration, Context context) {
        Method method;
        if (Build.VERSION.SDK_INT >= 25 && (method = f1829a) != null) {
            try {
