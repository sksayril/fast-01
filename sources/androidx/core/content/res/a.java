...
class a {
    ...
    public int o(l lVar) {
        ...
        float[][] fArr = b.f1404b;
        return androidx.core.graphics.a.a((double) ((fArr[0][0] * f18) + (fArr[0][1] * f19) + (fArr[0][2] * f20)), (double) ((fArr[1][0] * f18) + (fArr[1][1] * f19) + (fArr[1][2] * f20)), (double) ((f18 * fArr[2][0]) + (f19 * fArr[2][1]) + (f20 * fArr[2][2])));
    }
