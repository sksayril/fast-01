...
public final class a {
    ...
    private static final Object f11094f = new Object();

    /* renamed from: g  reason: collision with root package name */
    private static a f11095g;

    /* renamed from: a  reason: collision with root package name */
    private final Context f11096a;

    /* renamed from: b  reason: collision with root package name */
    private final HashMap<BroadcastReceiver, ArrayList<c>> f11097b = new HashMap<>();

    /* renamed from: c  reason: collision with root package name */
    private final HashMap<String, ArrayList<c>> f11098c = new HashMap<>();

    /* renamed from: d  reason: collision with root package name */
    private final ArrayList<b> f11099d = new ArrayList<>();

    /* renamed from: e  reason: collision with root package name */
    private final Handler f11100e;

    /* renamed from: l0.a$a  reason: collision with other inner class name */
    class C0177a extends Handler {
        C0177a(Looper looper) {
            super(looper);
        }
    ...
    private static final class b {
        ...
        /* renamed from: a  reason: collision with root package name */
        final Intent f11102a;

        /* renamed from: b  reason: collision with root package name */
        final ArrayList<c> f11103b;
    ...
    private static final class c {
        ...
        /* renamed from: a  reason: collision with root package name */
        final IntentFilter f11104a;

        /* renamed from: b  reason: collision with root package name */
        final BroadcastReceiver f11105b;
        ...
        c(IntentFilter intentFilter, BroadcastReceiver broadcastReceiver) {
            this.f11104a = intentFilter;
            this.f11105b = broadcastReceiver;
        }
    ...
    private a(Context context) {
        ...
        this.f11100e = new C0177a(context.getMainLooper());
    }

    public static a b(Context context) {
        a aVar;
        synchronized (f11094f) {
            if (f11095g == null) {
                f11095g = new a(context.getApplicationContext());
            }
            aVar = f11095g;
        }
        return aVar;
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:13:0x0029, code lost:
        r7 = r4.f11103b.get(r6);
     */
    /* JADX WARNING: Code restructure failed: missing block: B:14:0x0033, code lost:
        if (r7.f11107d != false) goto L_0x003e;
     */
    /* JADX WARNING: Code restructure failed: missing block: B:15:0x0035, code lost:
        r7.f11105b.onReceive(r10.f11096a, r4.f11102a);
     */
    ...
    public void a() {
        /*
            r10 = this;
        L_0x0000:
            java.util.HashMap<android.content.BroadcastReceiver, java.util.ArrayList<l0.a$c>> r0 = r10.f11097b
            monitor-enter(r0)
            java.util.ArrayList<l0.a$b> r1 = r10.f11099d     // Catch:{ all -> 0x0044 }
            int r1 = r1.size()     // Catch:{ all -> 0x0044 }
            if (r1 > 0) goto L_0x000d
            monitor-exit(r0)     // Catch:{ all -> 0x0044 }
            return
        L_0x000d:
            l0.a$b[] r2 = new l0.a.b[r1]     // Catch:{ all -> 0x0044 }
            java.util.ArrayList<l0.a$b> r3 = r10.f11099d     // Catch:{ all -> 0x0044 }
        ...
        L_0x001c:
            if (r3 >= r1) goto L_0x0000
            r4 = r2[r3]
            java.util.ArrayList<l0.a$c> r5 = r4.f11103b
            int r5 = r5.size()
            r6 = 0
        L_0x0027:
            if (r6 >= r5) goto L_0x0041
            java.util.ArrayList<l0.a$c> r7 = r4.f11103b
            java.lang.Object r7 = r7.get(r6)
            l0.a$c r7 = (l0.a.c) r7
            boolean r8 = r7.f11107d
            if (r8 != 0) goto L_0x003e
            android.content.BroadcastReceiver r7 = r7.f11105b
            android.content.Context r8 = r10.f11096a
            android.content.Intent r9 = r4.f11102a
            r7.onReceive(r8, r9)
        L_0x003e:
            int r6 = r6 + 1
            goto L_0x0027
        ...
        L_0x0044:
            ...
            throw r1
        */
        throw new UnsupportedOperationException("Method not decompiled: l0.a.a():void");
    }

    public void c(BroadcastReceiver broadcastReceiver, IntentFilter intentFilter) {
        synchronized (this.f11097b) {
            c cVar = new c(intentFilter, broadcastReceiver);
            ArrayList arrayList = this.f11097b.get(broadcastReceiver);
            if (arrayList == null) {
                arrayList = new ArrayList(1);
                this.f11097b.put(broadcastReceiver, arrayList);
            }
            arrayList.add(cVar);
            for (int i10 = 0; i10 < intentFilter.countActions(); i10++) {
                String action = intentFilter.getAction(i10);
                ArrayList arrayList2 = this.f11098c.get(action);
                if (arrayList2 == null) {
                    arrayList2 = new ArrayList(1);
                    this.f11098c.put(action, arrayList2);
                }
                arrayList2.add(cVar);
            }
        }
    ...
    public boolean d(android.content.Intent r22) {
        /*
            ...
            r1 = r21
            r0 = r22
            java.util.HashMap<android.content.BroadcastReceiver, java.util.ArrayList<l0.a$c>> r2 = r1.f11097b
            monitor-enter(r2)
            java.lang.String r10 = r22.getAction()     // Catch:{ all -> 0x0175 }
            android.content.Context r3 = r1.f11096a     // Catch:{ all -> 0x0175 }
        ...
        L_0x0056:
            java.util.HashMap<java.lang.String, java.util.ArrayList<l0.a$c>> r3 = r1.f11098c     // Catch:{ all -> 0x0175 }
        ...
        L_0x0080:
            ...
            r5 = r3
            l0.a$c r5 = (l0.a.c) r5     // Catch:{ all -> 0x0175 }
            ...
            android.content.IntentFilter r9 = r5.f11104a     // Catch:{ all -> 0x0175 }
            r4.append(r9)     // Catch:{ all -> 0x0175 }
            java.lang.String r4 = r4.toString()     // Catch:{ all -> 0x0175 }
            android.util.Log.v(r3, r4)     // Catch:{ all -> 0x0175 }
        L_0x00a7:
            boolean r3 = r5.f11106c     // Catch:{ all -> 0x0175 }
        ...
        L_0x00b4:
            ...
            goto L_0x0137
        L_0x00c0:
            android.content.IntentFilter r3 = r5.f11104a     // Catch:{ all -> 0x0175 }
        ...
        L_0x00ff:
            ...
            r15.f11106c = r11     // Catch:{ all -> 0x0175 }
            goto L_0x0138
        L_0x0105:
        ...
        L_0x0147:
            ...
            l0.a$c r4 = (l0.a.c) r4     // Catch:{ all -> 0x0175 }
            r5 = 0
            r4.f11106c = r5     // Catch:{ all -> 0x0175 }
            int r3 = r3 + 1
            goto L_0x0147
        L_0x0159:
            java.util.ArrayList<l0.a$b> r3 = r1.f11099d     // Catch:{ all -> 0x0175 }
            l0.a$b r4 = new l0.a$b     // Catch:{ all -> 0x0175 }
            r4.<init>(r0, r10)     // Catch:{ all -> 0x0175 }
            r3.add(r4)     // Catch:{ all -> 0x0175 }
            android.os.Handler r0 = r1.f11100e     // Catch:{ all -> 0x0175 }
        ...
        L_0x0175:
            ...
            throw r0
        */
        throw new UnsupportedOperationException("Method not decompiled: l0.a.d(android.content.Intent):boolean");
    }

    public void e(BroadcastReceiver broadcastReceiver) {
        synchronized (this.f11097b) {
            ArrayList remove = this.f11097b.remove(broadcastReceiver);
            if (remove != null) {
                for (int size = remove.size() - 1; size >= 0; size--) {
                    c cVar = (c) remove.get(size);
                    cVar.f11107d = true;
                    for (int i10 = 0; i10 < cVar.f11104a.countActions(); i10++) {
                        String action = cVar.f11104a.getAction(i10);
                        ArrayList arrayList = this.f11098c.get(action);
                        if (arrayList != null) {
                            for (int size2 = arrayList.size() - 1; size2 >= 0; size2--) {
                                c cVar2 = (c) arrayList.get(size2);
                                if (cVar2.f11105b == broadcastReceiver) {
                                    cVar2.f11107d = true;
                                    arrayList.remove(size2);
                                }
                            }
                            if (arrayList.size() <= 0) {
                                this.f11098c.remove(action);
                            }
                        }
                    }
                }
