...
public class d {
    ...
    private static class a implements TypeEvaluator<d.b[]> {
        ...
        public d.b[] evaluate(float f10, d.b[] bVarArr, d.b[] bVarArr2) {
            if (androidx.core.graphics.d.b(bVarArr, bVarArr2)) {
                if (!androidx.core.graphics.d.b(this.f3263a, bVarArr)) {
                    this.f3263a = androidx.core.graphics.d.f(bVarArr);
                }
                for (int i10 = 0; i10 < bVarArr.length; i10++) {
                    this.f3263a[i10].d(bVarArr[i10], bVarArr2[i10], f10);
                }
                return this.f3263a;
            }
    ...
    private static android.animation.Animator b(android.content.Context r18, android.content.res.Resources r19, android.content.res.Resources.Theme r20, org.xmlpull.v1.XmlPullParser r21, android.util.AttributeSet r22, android.animation.AnimatorSet r23, int r24, float r25) {
        ...
        L_0x005d:
            ...
            r15.<init>()
            int[] r0 = androidx.vectordrawable.graphics.drawable.a.f3245h
            r7 = r22
    ...
    private static android.animation.PropertyValuesHolder e(android.content.res.TypedArray r11, int r12, int r13, int r14, java.lang.String r15) {
        ...
        L_0x003c:
            ...
            androidx.core.graphics.d$b[] r13 = androidx.core.graphics.d.d(r12)
            androidx.core.graphics.d$b[] r14 = androidx.core.graphics.d.d(r11)
        ...
        L_0x0054:
            ...
            boolean r3 = androidx.core.graphics.d.b(r13, r14)
        ...
        L_0x00a9:
            ...
            androidx.vectordrawable.graphics.drawable.e r12 = androidx.vectordrawable.graphics.drawable.e.a()
            goto L_0x00b1
        L_0x00b0:
            r12 = r8
        L_0x00b1:
        ...
        L_0x0167:
            return r8
        */
        throw new UnsupportedOperationException("Method not decompiled: androidx.vectordrawable.graphics.drawable.d.e(android.content.res.TypedArray, int, int, int, java.lang.String):android.animation.PropertyValuesHolder");
    }
    ...
    private static int f(TypedArray typedArray, int i10, int i11) {
        ...
        return ((!z10 || !h(i12)) && (!z9 || !h(z9 ? peekValue2.type : 0))) ? 0 : 3;
    }

    private static int g(Resources resources, Resources.Theme theme, AttributeSet attributeSet, XmlPullParser xmlPullParser) {
        TypedArray k10 = k.k(resources, theme, attributeSet, a.f3247j);
        int i10 = 0;
        TypedValue l10 = k.l(k10, xmlPullParser, "value", 0);
    ...
    private static ValueAnimator l(Context context, Resources resources, Resources.Theme theme, AttributeSet attributeSet, ValueAnimator valueAnimator, float f10, XmlPullParser xmlPullParser) {
        TypedArray k10 = k.k(resources, theme, attributeSet, a.f3244g);
        TypedArray k11 = k.k(resources, theme, attributeSet, a.f3248k);
        ...
        if (h10 > 0) {
            valueAnimator.setInterpolator(c.a(context, h10));
        }
        k10.recycle();
        if (k11 != null) {
            k11.recycle();
    ...
    private static Keyframe m(Context context, Resources resources, Resources.Theme theme, AttributeSet attributeSet, int i10, XmlPullParser xmlPullParser) {
        ...
        boolean z9 = l10 != null;
        if (i10 == 4) {
            i10 = (!z9 || !h(l10.type)) ? 0 : 3;
        }
        Keyframe ofInt = z9 ? i10 != 0 ? (i10 == 1 || i10 == 3) ? Keyframe.ofInt(f10, k.g(k10, xmlPullParser, "value", 0, 0)) : null : Keyframe.ofFloat(f10, k.f(k10, xmlPullParser, "value", 0, 0.0f)) : i10 == 0 ? Keyframe.ofFloat(f10) : Keyframe.ofInt(f10);
        int h10 = k.h(k10, xmlPullParser, "interpolator", 1, 0);
        if (h10 > 0) {
            ofInt.setInterpolator(c.a(context, h10));
        }
        k10.recycle();
        return ofInt;
    }
    ...
    private static android.animation.PropertyValuesHolder o(android.content.Context r9, android.content.res.Resources r10, android.content.res.Resources.Theme r11, org.xmlpull.v1.XmlPullParser r12, java.lang.String r13, int r14) {
        ...
        L_0x00dc:
            ...
            androidx.vectordrawable.graphics.drawable.e r9 = androidx.vectordrawable.graphics.drawable.e.a()
            r0.setEvaluator(r9)
        L_0x00e9:
            return r0
        */
        throw new UnsupportedOperationException("Method not decompiled: androidx.vectordrawable.graphics.drawable.d.o(android.content.Context, android.content.res.Resources, android.content.res.Resources$Theme, org.xmlpull.v1.XmlPullParser, java.lang.String, int):android.animation.PropertyValuesHolder");
    }
    ...
    private static android.animation.PropertyValuesHolder[] p(android.content.Context r17, android.content.res.Resources r18, android.content.res.Resources.Theme r19, org.xmlpull.v1.XmlPullParser r20, android.util.AttributeSet r21) {
        ...
        L_0x0016:
            ...
            int[] r0 = androidx.vectordrawable.graphics.drawable.a.f3246i
            r11 = r18
            r12 = r19
            r13 = r21
            ...
            int r5 = androidx.core.content.res.k.g(r14, r6, r1, r2, r0)
            r0 = r17
            r1 = r18
            r2 = r19
            r3 = r20
        ...
        L_0x007f:
            return r7
        */
        throw new UnsupportedOperationException("Method not decompiled: androidx.vectordrawable.graphics.drawable.d.p(android.content.Context, android.content.res.Resources, android.content.res.Resources$Theme, org.xmlpull.v1.XmlPullParser, android.util.AttributeSet):android.animation.PropertyValuesHolder[]");
    }
    ...
    private static void q(ValueAnimator valueAnimator, TypedArray typedArray, TypedArray typedArray2, float f10, XmlPullParser xmlPullParser) {
        long g10 = (long) k.g(typedArray, xmlPullParser, "duration", 1, 300);
        long g11 = (long) k.g(typedArray, xmlPullParser, "startOffset", 2, 0);
        ...
        if (k.j(xmlPullParser, "valueFrom") && k.j(xmlPullParser, "valueTo")) {
            ...
            if (e10 != null) {
                valueAnimator.setValues(new PropertyValuesHolder[]{e10});
            }
        }
