...
public class c {
    ...
    private File a() {
        if (this.f12726a == null) {
            synchronized (this) {
                if (this.f12726a == null) {
                    File filesDir = this.f12727b.m().getFilesDir();
                    this.f12726a = new File(filesDir, "PersistedInstallation." + this.f12727b.s() + ".json");
                }
            }
        }
        return this.f12726a;
    ...
    public d b(d dVar) {
        try {
            ...
            File createTempFile = File.createTempFile("PersistedInstallation", "tmp", this.f12727b.m().getFilesDir());
