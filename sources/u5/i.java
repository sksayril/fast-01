...
public class i extends b {
    ...
    private static final byte[] f12504d = new byte[0];

    /* renamed from: b  reason: collision with root package name */
    private byte[] f12505b = f12504d;

    /* renamed from: c  reason: collision with root package name */
    private final int[] f12506c = new int[32];
    ...
    private void h(int i10) {
        if (this.f12505b.length < i10) {
            this.f12505b = new byte[i10];
        }
    ...
    public b b() {
        ...
        for (int i10 = 1; i10 < 5; i10++) {
            byte[] c10 = e10.c((a10 * i10) / 5, this.f12505b);
            int i11 = (d10 * 4) / 5;
    ...
    public a c(int i10, a aVar) {
        ...
        h(d10);
        byte[] c10 = e10.c(i10, this.f12505b);
        int[] iArr = this.f12506c;
