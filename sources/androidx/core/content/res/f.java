...
final class f {
    ...
    static final class a {
        ...
        a(int i10, int i11) {
            this.f1422a = new int[]{i10, i11};
            this.f1423b = new float[]{0.0f, 1.0f};
        }

        a(int i10, int i11, int i12) {
            this.f1422a = new int[]{i10, i11, i12};
            this.f1423b = new float[]{0.0f, 0.5f, 1.0f};
        }

        a(List<Integer> list, List<Float> list2) {
            int size = list.size();
            this.f1422a = new int[size];
            this.f1423b = new float[size];
            for (int i10 = 0; i10 < size; i10++) {
                this.f1422a[i10] = list.get(i10).intValue();
                this.f1423b[i10] = list2.get(i10).floatValue();
            }
        }
    }
    ...
    static Shader b(Resources resources, XmlPullParser xmlPullParser, AttributeSet attributeSet, Resources.Theme theme) {
        ...
        if (name.equals("gradient")) {
            ...
            TypedArray k10 = k.k(resources, theme2, attributeSet, i.A);
            float f10 = k.f(k10, xmlPullParser2, "startX", i.J, 0.0f);
            float f11 = k.f(k10, xmlPullParser2, "startY", i.K, 0.0f);
            float f12 = k.f(k10, xmlPullParser2, "endX", i.L, 0.0f);
            float f13 = k.f(k10, xmlPullParser2, "endY", i.M, 0.0f);
            float f14 = k.f(k10, xmlPullParser2, "centerX", i.E, 0.0f);
            float f15 = k.f(k10, xmlPullParser2, "centerY", i.F, 0.0f);
            int g10 = k.g(k10, xmlPullParser2, "type", i.D, 0);
            int b10 = k.b(k10, xmlPullParser2, "startColor", i.B, 0);
            boolean j10 = k.j(xmlPullParser2, "centerColor");
            int b11 = k.b(k10, xmlPullParser2, "centerColor", i.I, 0);
            int b12 = k.b(k10, xmlPullParser2, "endColor", i.C, 0);
            int g11 = k.g(k10, xmlPullParser2, "tileMode", i.H, 0);
            float f16 = f14;
            float f17 = k.f(k10, xmlPullParser2, "gradientRadius", i.G, 0.0f);
            k10.recycle();
            ...
            if (g10 == 1) {
                ...
                if (f17 > 0.0f) {
                    int[] iArr = a10.f1422a;
                    return new RadialGradient(f18, f15, f17, iArr, a10.f1423b, d(g11));
                }
                throw new XmlPullParserException("<gradient> tag requires 'gradientRadius' attribute with radial type");
            } else if (g10 != 2) {
                return new LinearGradient(f10, f11, f12, f13, a10.f1422a, a10.f1423b, d(g11));
            } else {
                return new SweepGradient(f16, f15, a10.f1422a, a10.f1423b);
            }
        } else {
