...
public final class d {
    ...
    private final Shader f1408a;

    /* renamed from: b  reason: collision with root package name */
    private final ColorStateList f1409b;
    ...
    public boolean i() {
        /*
            r1 = this;
            android.graphics.Shader r0 = r1.f1408a
            if (r0 != 0) goto L_0x0010
            android.content.res.ColorStateList r0 = r1.f1409b
            if (r0 == 0) goto L_0x0010
    ...
    public boolean j(int[] iArr) {
        if (i()) {
            ColorStateList colorStateList = this.f1409b;
            int colorForState = colorStateList.getColorForState(iArr, colorStateList.getDefaultColor());
            if (colorForState != this.f1410c) {
                this.f1410c = colorForState;
                return true;
            }
        }
        return false;
