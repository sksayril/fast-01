...
final class a {
    ...
    public byte[] a() {
        ...
        int n10 = this.f3407a.n();
        int r9 = this.f3407a.r();
        for (int i10 = 0; i10 < n10; i10++) {
            int[] iArr = f3406b[i10];
            for (int i11 = 0; i11 < r9; i11++) {
                int i12 = iArr[i11];
                if (i12 >= 0 && this.f3407a.h(i11, i10)) {
                    int i13 = i12 / 6;
