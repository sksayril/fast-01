...
public final class SplitRuleParser {
    private final ComponentName buildClassName(String str, CharSequence charSequence) {
        if (charSequence != null) {
            if (!(charSequence.length() == 0)) {
                ...
                int C = p.C(obj, '/', 0, false, 6, (Object) null);
                if (C > 0) {
                ...
                if (l.a(obj, "*") || p.C(obj, '.', 0, false, 6, (Object) null) >= 0) {
    ...
    private final ActivityRule parseSplitActivityRule(Context context, XmlResourceParser xmlResourceParser) {
        return new ActivityRule(k0.b(), context.getTheme().obtainStyledAttributes(xmlResourceParser, R.styleable.ActivityRule, 0, 0).getBoolean(R.styleable.ActivityRule_alwaysExpand, false));
    }
    ...
    private final java.util.Set<androidx.window.embedding.EmbeddingRule> parseSplitXml(android.content.Context r9, int r10) {
        /*
            ...
            r1 = 0
            android.content.res.XmlResourceParser r10 = r0.getXml(r10)     // Catch:{ NotFoundException -> 0x00ec }
            java.lang.String r0 = "resources.getXml(splitResourceId)"
            kotlin.jvm.internal.l.d(r10, r0)     // Catch:{ NotFoundException -> 0x00ec }
