...
public class g1 extends r0 {
    ...
    private static boolean f910c = false;

    /* renamed from: b  reason: collision with root package name */
    private final WeakReference<Context> f911b;

    public g1(Context context, Resources resources) {
        super(resources);
        this.f911b = new WeakReference<>(context);
    }
    ...
    public Drawable getDrawable(int i10) {
        Context context = (Context) this.f911b.get();
        return context != null ? q0.h().t(context, this, i10) : a(i10);
    }
    ...
    public /* bridge */ /* synthetic */ void getValue(int i10, TypedValue typedValue, boolean z9) {
        super.getValue(i10, typedValue, z9);
    }
    ...
    public /* bridge */ /* synthetic */ void getValueForDensity(int i10, int i11, TypedValue typedValue, boolean z9) {
        super.getValueForDensity(i10, i11, typedValue, z9);
    }
