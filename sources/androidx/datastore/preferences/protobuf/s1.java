...
final class s1 {
    ...
    private static final b f2084a = ((!e.e() || d.c()) ? new c() : new e());
    ...
    static final class c extends b {
        ...
        public int d(int r7, byte[] r8, int r9, int r10) {
            ...
            L_0x001c:
                ...
                int r7 = androidx.datastore.preferences.protobuf.s1.j(r0, r9)
                return r7
            L_0x0031:
                r5 = r9
                r9 = r7
            ...
            L_0x0049:
                ...
                int r7 = androidx.datastore.preferences.protobuf.s1.j(r0, r1)
                return r7
            L_0x005b:
                r9 = r7
                goto L_0x0060
            ...
            L_0x0060:
                ...
                int r7 = androidx.datastore.preferences.protobuf.s1.k(r0, r1, r4)
                return r7
            L_0x006d:
                r9 = r7
            L_0x006e:
    ...
    static final class e extends b {
        ...
        public String a(byte[] bArr, int i10, int i11) {
            if ((i10 | i11 | ((bArr.length - i10) - i11)) >= 0) {
                ...
                while (r13 < i12) {
                    int i15 = r13 + 1;
                    byte s10 = r1.s(bArr, (long) r13);
                    if (a.n(s10)) {
                        int i16 = i14 + 1;
                        a.i(s10, cArr, i14);
                        while (i15 < i12) {
                            byte s11 = r1.s(bArr, (long) i15);
                            if (!a.n(s11)) {
                                break;
                            }
                            i15++;
                        ...
                        if (i15 < i12) {
                            int i17 = i15 + 1;
                            a.k(s10, r1.s(bArr, (long) i15), cArr, i14);
                            r13 = i17;
                            i14++;
                        } else {
                            throw b0.c();
                        ...
                        if (i15 < i12 - 1) {
                            int i18 = i15 + 1;
                            int i19 = i18 + 1;
                            a.j(s10, r1.s(bArr, (long) i15), r1.s(bArr, (long) i18), cArr, i14);
                            r13 = i19;
                            i14++;
                        } else {
                            throw b0.c();
                        ...
                        int i20 = i15 + 1;
                        byte s12 = r1.s(bArr, (long) i15);
                        int i21 = i20 + 1;
                        a.h(s10, s12, r1.s(bArr, (long) i20), r1.s(bArr, (long) i21), cArr, i14);
                        r13 = i21 + 1;
                        i14 = i14 + 1 + 1;
                    } else {
                        throw b0.c();
        ...
        public int b(java.lang.CharSequence r23, byte[] r24, int r25, int r26) {
            ...
            L_0x001a:
                ...
                long r11 = r11 + r4
                byte r3 = (byte) r13
                androidx.datastore.preferences.protobuf.r1.H(r1, r4, r3)
                int r2 = r2 + 1
                r4 = r11
                goto L_0x001a
            L_0x002f:
            ...
            L_0x0033:
                ...
                long r14 = r4 + r11
                byte r13 = (byte) r13
                androidx.datastore.preferences.protobuf.r1.H(r1, r4, r13)
                r4 = r11
                r12 = r14
            L_0x0047:
            ...
            L_0x004b:
                ...
                r5 = r5 | r13
                byte r5 = (byte) r5
                androidx.datastore.preferences.protobuf.r1.H(r1, r14, r5)
                r20 = r11
                r11 = 128(0x80, float:1.794E-43)
                r12 = r3
                r4 = r20
            ...
            L_0x007f:
                ...
                r5 = r5 | r11
                byte r5 = (byte) r5
                androidx.datastore.preferences.protobuf.r1.H(r1, r3, r5)
                r12 = r18
                r4 = 1
                goto L_0x0047
            L_0x00ae:
                ...
                byte r15 = (byte) r15
                androidx.datastore.preferences.protobuf.r1.H(r1, r4, r15)
                long r4 = r13 + r11
                int r15 = r2 >>> 12
                r15 = r15 & 63
                r11 = 128(0x80, float:1.794E-43)
                ...
                byte r12 = (byte) r12
                androidx.datastore.preferences.protobuf.r1.H(r1, r13, r12)
                r12 = 1
                long r14 = r4 + r12
                int r16 = r2 >>> 6
                r12 = r16 & 63
                r12 = r12 | r11
                byte r12 = (byte) r12
                androidx.datastore.preferences.protobuf.r1.H(r1, r4, r12)
                r4 = 1
                long r12 = r14 + r4
                r2 = r2 & 63
                r2 = r2 | r11
                byte r2 = (byte) r2
                androidx.datastore.preferences.protobuf.r1.H(r1, r14, r2)
                r2 = r3
            L_0x00fb:
                int r2 = r2 + 1
                r3 = 128(0x80, float:1.794E-43)
            ...
            L_0x0106:
                r2 = r3
            L_0x0107:
                androidx.datastore.preferences.protobuf.s1$d r0 = new androidx.datastore.preferences.protobuf.s1$d
                int r2 = r2 + -1
                r0.<init>(r2, r8)
                throw r0
            L_0x010f:
            ...
            L_0x0144:
                ...
                throw r1
            */
            throw new UnsupportedOperationException("Method not decompiled: androidx.datastore.preferences.protobuf.s1.e.b(java.lang.CharSequence, byte[], int, int):int");
        }

        /* access modifiers changed from: package-private */
        /* JADX WARNING: Code restructure failed: missing block: B:32:0x0059, code lost:
            if (androidx.datastore.preferences.protobuf.r1.s(r13, r2) > -65) goto L_0x005e;
         */
        /* JADX WARNING: Code restructure failed: missing block: B:54:0x009e, code lost:
            if (androidx.datastore.preferences.protobuf.r1.s(r13, r2) > -65) goto L_0x00a0;
         */
        /* Code decompiled incorrectly, please refer to instructions dump. */
        public int d(int r12, byte[] r13, int r14, int r15) {
            ...
            L_0x0011:
                ...
                long r7 = r7 + r2
                byte r12 = androidx.datastore.preferences.protobuf.r1.s(r13, r2)
            ...
            L_0x002b:
                ...
                int r12 = androidx.datastore.preferences.protobuf.s1.j(r0, r12)
                return r12
            L_0x0044:
                r2 = r9
            L_0x0045:
            ...
            L_0x005f:
                ...
                long r9 = r2 + r7
                byte r4 = androidx.datastore.preferences.protobuf.r1.s(r13, r2)
                int r12 = (r9 > r14 ? 1 : (r9 == r14 ? 0 : -1))
                if (r12 < 0) goto L_0x0074
                int r12 = androidx.datastore.preferences.protobuf.s1.j(r0, r4)
                return r12
            L_0x0074:
                r2 = r9
                goto L_0x0079
            ...
            L_0x0079:
                ...
                long r9 = r2 + r7
                byte r1 = androidx.datastore.preferences.protobuf.r1.s(r13, r2)
                int r12 = (r9 > r14 ? 1 : (r9 == r14 ? 0 : -1))
                if (r12 < 0) goto L_0x008a
                int r12 = androidx.datastore.preferences.protobuf.s1.k(r0, r4, r1)
                return r12
            L_0x008a:
                r2 = r9
            L_0x008b:
    ...
    static String e(byte[] bArr, int i10, int i11) {
        return f2084a.a(bArr, i10, i11);
    }

    static int f(CharSequence charSequence, byte[] bArr, int i10, int i11) {
        return f2084a.b(charSequence, bArr, i10, i11);
    }
    ...
    public static boolean m(byte[] bArr) {
        return f2084a.c(bArr, 0, bArr.length);
    }

    public static boolean n(byte[] bArr, int i10, int i11) {
        return f2084a.c(bArr, i10, i11);
    }
}
