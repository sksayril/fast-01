...
public final class MediaMetadataCompat implements Parcelable {
    ...
    static final p.a<String, Integer> f76o;

    /* renamed from: p  reason: collision with root package name */
    private static final String[] f77p = {"android.media.metadata.TITLE", "android.media.metadata.ARTIST", "android.media.metadata.ALBUM", "android.media.metadata.ALBUM_ARTIST", "android.media.metadata.WRITER", "android.media.metadata.AUTHOR", "android.media.metadata.COMPOSER"};

    /* renamed from: q  reason: collision with root package name */
    private static final String[] f78q = {"android.media.metadata.DISPLAY_ICON", "android.media.metadata.ART", "android.media.metadata.ALBUM_ART"};

    /* renamed from: r  reason: collision with root package name */
    private static final String[] f79r = {"android.media.metadata.DISPLAY_ICON_URI", "android.media.metadata.ART_URI", "android.media.metadata.ALBUM_ART_URI"};

    /* renamed from: m  reason: collision with root package name */
    final Bundle f80m;

    /* renamed from: n  reason: collision with root package name */
    private MediaMetadata f81n;
    ...
    MediaMetadataCompat(Parcel parcel) {
        this.f80m = parcel.readBundle(MediaSessionCompat.class.getClassLoader());
    }
    ...
    public static MediaMetadataCompat a(Object obj) {
        ...
        obtain.recycle();
        createFromParcel.f81n = mediaMetadata;
