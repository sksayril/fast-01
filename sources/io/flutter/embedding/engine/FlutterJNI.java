...
public class FlutterJNI {
    ...
    private z6.a deferredComponentManager;
    private final Set<a.b> engineLifecycleListeners = new CopyOnWriteArraySet();
    private final Set<j7.b> flutterUiDisplayListeners = new CopyOnWriteArraySet();
    private l7.a localizationPlugin;
    ...
    public static Bitmap decodeImage(ByteBuffer byteBuffer, long j10) {
        if (Build.VERSION.SDK_INT >= 28) {
            try {
                ...
                x6.b.c(TAG, "Failed to decode image", e10);
            }
        }
        return null;
    }
    ...
    private native void nativeDeferredComponentInstallFailure(int i10, String str, boolean z9);
    ...
    public void addIsDisplayingFlutterUiListener(j7.b bVar) {
        ensureRunningOnMainThread();
    ...
    public String[] computePlatformResolvedLocale(String[] strArr) {
        ...
        return new String[]{c10.getLanguage(), c10.getCountry(), c10.getScript()};
    }
    ...
    public void deferredComponentInstallFailure(int i10, String str, boolean z9) {
        ensureRunningOnMainThread();
        nativeDeferredComponentInstallFailure(i10, str, z9);
    }
    ...
    public void dispatchEmptyPlatformMessage(String str, int i10) {
        ...
        x6.b.g(TAG, "Tried to send a platform message to Flutter, but FlutterJNI was detached from native C++. Could not send. Channel: " + str + ". Response ID: " + i10);
    }
    ...
    public void dispatchPlatformMessage(String str, ByteBuffer byteBuffer, int i10, int i11) {
        ...
        x6.b.g(TAG, "Tried to send a platform message to Flutter, but FlutterJNI was detached from native C++. Could not send. Channel: " + str + ". Response ID: " + i11);
    }
    ...
    public void dispatchSemanticsAction(int i10, c.g gVar, Object obj) {
        ...
        ensureAttachedToNative();
        if (obj != null) {
            byteBuffer = r.f11008a.a(obj);
            i11 = byteBuffer.position();
        } else {
            byteBuffer = null;
            i11 = 0;
        }
        dispatchSemanticsAction(i10, gVar.value, byteBuffer, i11);
    }
    ...
    public void init(Context context, String[] strArr, String str, String str2, String str3, long j10) {
        if (initCalled) {
            x6.b.g(TAG, "FlutterJNI.init called more than once");
        }
    ...
    public void invokePlatformMessageEmptyResponseCallback(int i10) {
        ...
        try {
            if (isAttached()) {
                ...
                x6.b.g(TAG, "Tried to send a platform message response, but FlutterJNI was detached from native C++. Could not send. Response ID: " + i10);
            }
        } finally {
    ...
    public void loadLibrary() {
        if (loadLibraryCalled) {
            x6.b.g(TAG, "FlutterJNI.loadLibrary called more than once");
        }
    ...
    public void onFirstFrame() {
        ensureRunningOnMainThread();
        for (j7.b f10 : this.flutterUiDisplayListeners) {
            f10.f();
        }
    }
    ...
    public void onRenderingStopped() {
        ensureRunningOnMainThread();
        for (j7.b c10 : this.flutterUiDisplayListeners) {
            c10.c();
        }
    }
    ...
    public void prefetchDefaultFontManager() {
        if (prefetchDefaultFontManagerCalled) {
            x6.b.g(TAG, "FlutterJNI.prefetchDefaultFontManager called more than once");
        }
    ...
    public void removeIsDisplayingFlutterUiListener(j7.b bVar) {
        ensureRunningOnMainThread();
        this.flutterUiDisplayListeners.remove(bVar);
    }

    public void requestDartDeferredLibrary(int i10) {
        z6.a aVar = this.deferredComponentManager;
        if (aVar != null) {
            aVar.e(i10, (String) null);
        } else {
            x6.b.b(TAG, "No DeferredComponentManager found. Android setup must be completed before using split AOT deferred components.");
        }
    }
    ...
    public void setDeferredComponentManager(z6.a aVar) {
        ensureRunningOnMainThread();
    ...
    public void setLocalizationPlugin(l7.a aVar) {
        ensureRunningOnMainThread();
    ...
    public FlutterJNI spawn(String str, String str2, String str3, List<String> list) {
        ...
        d8.c.a((l10 == null || l10.longValue() == 0) ? false : true, "Failed to spawn new JNI connected shell from existing shell.");
        return nativeSpawn;
    }
