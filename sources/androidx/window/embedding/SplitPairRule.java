...
public final class SplitPairRule extends SplitRule {
    ...
    public SplitPairRule(Set<SplitPairFilter> set, boolean z9, boolean z10, boolean z11, int i10, int i11, float f10, int i12) {
    ...
    public /* synthetic */ SplitPairRule(java.util.Set r8, boolean r9, boolean r10, boolean r11, int r12, int r13, float r14, int r15, int r16, kotlin.jvm.internal.g r17) {
        /*
            r7 = this;
            r0 = r16
            r1 = r0 & 2
    ...
    public final SplitPairRule plus$window_release(SplitPairFilter splitPairFilter) {
        ...
        return new SplitPairRule(v.D(linkedHashSet), this.finishPrimaryWithSecondary, this.finishSecondaryWithPrimary, this.clearTop, getMinWidth(), getMinSmallestWidth(), getSplitRatio(), getLayoutDirection());
    }
}
