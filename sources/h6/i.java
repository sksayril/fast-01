...
final class i {
    ...
    private static final float[][] f9409a;

    static {
        int i10;
        int length = a.f8947b.length;
        int[] iArr = new int[2];
        iArr[1] = 8;
        iArr[0] = length;
        f9409a = (float[][]) Array.newInstance(float.class, iArr);
        int i11 = 0;
        while (true) {
            int[] iArr2 = a.f8947b;
            if (i11 < iArr2.length) {
