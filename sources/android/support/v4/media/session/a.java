    ...
    public static abstract class C0001a extends Binder implements a {
        ...
        public boolean onTransact(int r5, android.os.Parcel r6, android.os.Parcel r7, int r8) {
            ...
            L_0x00e7:
                ...
                return r1
            */
            throw new UnsupportedOperationException("Method not decompiled: android.support.v4.media.session.a.C0001a.onTransact(int, android.os.Parcel, android.os.Parcel, int):boolean");
        }
    }

    void A1(List<MediaSessionCompat.QueueItem> list);

    void F0(int i10);

    void L2(PlaybackStateCompat playbackStateCompat);
