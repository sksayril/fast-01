...
public class b {
    ...
    private static final String[] f12723c = {"*", "FCM", "GCM", ""};
    ...
    public b(f fVar) {
        this.f12724a = fVar.m().getSharedPreferences("com.google.android.gms.appid", 0);
        this.f12725b = b(fVar);
    }
    ...
    private String g() {
        ...
        synchronized (this.f12724a) {
            string = this.f12724a.getString("|S|id", (String) null);
        }
        return string;
    }
    ...
    private String h() {
        synchronized (this.f12724a) {
            String string = this.f12724a.getString("|S||P|", (String) null);
            if (string == null) {
                return null;
            }
    ...
    public java.lang.String i() {
        /*
            r7 = this;
            android.content.SharedPreferences r0 = r7.f12724a
            monitor-enter(r0)
            java.lang.String[] r1 = f12723c     // Catch:{ all -> 0x0033 }
        ...
        L_0x0007:
            ...
            java.lang.String r6 = r7.f12725b     // Catch:{ all -> 0x0033 }
            java.lang.String r5 = r7.a(r6, r5)     // Catch:{ all -> 0x0033 }
            android.content.SharedPreferences r6 = r7.f12724a     // Catch:{ all -> 0x0033 }
        ...
        L_0x0033:
            ...
            throw r1
        */
        throw new UnsupportedOperationException("Method not decompiled: v4.b.i():java.lang.String");
    }
}
