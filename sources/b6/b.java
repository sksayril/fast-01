...
final class b {
    ...
    private static final byte[] f3408a = {53, 54, 43, 44, 45, 46, 47, 48, 37, 38};

    /* renamed from: b  reason: collision with root package name */
    private static final byte[] f3409b = {55, 56, 57, 58, 59, 60, 49, 50, 51, 52};

    /* renamed from: c  reason: collision with root package name */
    private static final byte[] f3410c = {39, 40, 41, 42, 31, 32};

    /* renamed from: d  reason: collision with root package name */
    private static final byte[] f3411d = {33, 34, 35, 36, 25, 26, 27, 28, 29, 30, 19, 20, 21, 22, 23, 24, 13, 14, 15, 16, 17, 18, 7, 8, 9, 10, 11, 12, 1, 2};

    /* renamed from: e  reason: collision with root package name */
    private static final byte[][] f3412e = {new byte[]{39, 40, 41, 42, 31, 32}, new byte[]{33, 34, 35, 36, 25, 26}, new byte[]{27, 28, 29, 30, 19, 20}, new byte[]{21, 22, 23, 24, 13, 14}, new byte[]{15, 16, 17, 18, 7, 8}, new byte[]{9, 10, 11, 12, 1, 2}};

    /* renamed from: f  reason: collision with root package name */
    private static final String[] f3413f = {"\nABCDEFGHIJKLMNOPQRSTUVWXYZ￺\u001c\u001d\u001e￻ ￼\"#$%&'()*+,-./0123456789:￱￲￳￴￸", "`abcdefghijklmnopqrstuvwxyz￺\u001c\u001d\u001e￻{￼}~;<=>?[\\]^_ ,./:@!|￼￵￶￼￰￲￳￴￷", "ÀÁÂÃÄÅÆÇÈÉÊËÌÍÎÏÐÑÒÓÔÕÖ×ØÙÚ￺\u001c\u001d\u001e￻ÛÜÝÞßª¬±²³µ¹º¼½¾￷ ￹￳￴￸", "àáâãäåæçèéêëìíîïðñòóôõö÷øùú￺\u001c\u001d\u001e￻ûüýþÿ¡¨«¯°´·¸»¿￷ ￲￹￴￸", "\u0000\u0001\u0002\u0003\u0004\u0005\u0006\u0007\b\t\n\u000b\f\r\u000e\u000f\u0010\u0011\u0012\u0013\u0014\u0015\u0016\u0017\u0018\u0019\u001a￺￼￼\u001b￻\u001c\u001d\u001e\u001f ¢£¤¥¦§©­®¶￷ ￲￳￹￸"};
    ...
    static e a(byte[] bArr, int i10) {
        ...
        if (i10 == 2 || i10 == 3) {
            ...
            if (i10 == 2) {
                ...
                int g10 = g(bArr);
                if (g10 <= 10) {
                    str = new DecimalFormat("0000000000".substring(0, g10)).format((long) f10);
                } else {
                    throw f.a();
                }
            } else {
    ...
    private static java.lang.String e(byte[] r12, int r13, int r14) {
        ...
        L_0x0084:
            ...
            return r12
        */
        throw new UnsupportedOperationException("Method not decompiled: b6.b.e(byte[], int, int):java.lang.String");
    }

    private static int f(byte[] bArr) {
        return d(bArr, f3411d);
    }

    private static int g(byte[] bArr) {
        return d(bArr, f3410c);
    }
    ...
    private static String h(byte[] bArr) {
        ...
        for (byte[] d10 : bArr2) {
            sb.append(f3413f[0].charAt(d(bArr, d10)));
        }
        return sb.toString();
    }

    private static int i(byte[] bArr) {
        return d(bArr, f3409b);
    }
}
